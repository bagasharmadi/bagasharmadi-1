"""
Django settings for bagash project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-u0#&wm)(mhlm7df3nay4(3(2j^fl%ha*_5l6$99#c0+quff^-e')
...
WSGI_APPLICATION = 'bagash.wsgi.application'
